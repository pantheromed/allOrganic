...
class CartComponent extends Component
{
    ...
    public function saveForLater($rowId)
    {
        ...
        $this->emitTo('cart-count-component','refreshComponent');
        session()->flash('success_message', 'Produit enregistre !');
    }
    ...
    public function moveToCart($rowId)
    {
        ...
        Cart::instance('cart')->add($item->id, $item->name, $item->price)->associate('App\Models\Product');
        $this->emitTo('cart-count-component','refreshComponent');
        session()->flash('s_success_message', 'Produit Ajoute au panier !');
    }

    public function deleteFromSaveForLater($rowId)
    {
        Cart::instance('saveForLater')->remove($rowId);
        session()->flash('s_success_message', 'Produit bien supprime !');
    }
