            ...
            <ul class="product-list grid-products equal-container">
                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    ...
                    <div class="product-info">
                        ...
                        <div class="wrap-price"><span class="product-price">{{ $item->model->regular_price}} dhs</span></div>
                        <a href="#" class="btn add-to-cart" wire:click.prevent="moveProductToCart({{$item->model->id}})">Ajouter Au Panier</a>
