                ...
                <div class="panel-body">
                    ...
                    <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Nom du Produit" class="form-control input-md" wire:model="name" wire:keyup="generateSlug" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="prix du Produit" class="form-control input-md" wire:model="regular_price" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Quantite" class="form-control input-md" wire:model="quantity" required>
