<main id="main">
	<div class="container">
			...
			<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
				@foreach($sliders as $slide)
					<div class="item-slide" >
						<img src="{{ asset('assets/images/sliders') }}/{{$slide->image}}" alt="" class="img-slide"  style="height:400px">
						<div class="slide-info slide-3">
							<h2 class="f-title"><b>{{$slide->title}}</b></h2>
							<span class="subtitle">{{$slide->subtitle}}</span>
							<p class="sale-info" >Seulement a: <span class="price">{{$slide->price}} dhs</span></p>
							<a href="{{$slide->link}}" class="btn-link">Commandez maintenant</a>
						</div>
					</div>
				@endforeach
			</div>
		...
		<div class="wrap-banner style-twin-default">
			<div class="banner-item">
				<a href="" class="link-banner banner-effect-1">
					<figure><img src="{{ asset('assets/images/produit-naturel.jpg') }}" alt=""></figure>
				</a>
			</div>
			<div class="banner-item" style="height: 250px;">
				<a href="" class="link-banner banner-effect-1">
					<figure><img src="{{ asset('assets/images/produit-naturel-1.png') }}" alt=""></figure>
				</a>
			</div>
		</div>
		...
		<div class="wrap-show-advance-info-box style-1 has-countdown">
			<h3 class="title-box">En solde</h3>
			...
			<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
				...
				<div class="product product-style-2 equal-elem ">
					...
					<div class="product-info">
						...
						<div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}} dhs</p></ins> <del><p class="product-price">{{$sproduct->regular_price}} dhs</p></del></div>
					</div>
				</div>
				@endforeach
			</div>
		...
		<div class="wrap-show-advance-info-box style-1">
			...
			<div class="wrap-top-banner">
				<!-- <a href="#" class="link-banner banner-effect-2">
					<figure><img src="{{ asset('assets/images/produit-naturel.jpg') }}" width="1170" height="240" alt=""></figure>
				</a> -->
			</div>
							...
							<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">{{$lproduct->regular_price}} dhs</span></div>
									</div>
								</div>
								@endforeach
						</div>							
		...
		<!--Product Categories-->
		<div class="wrap-show-advance-info-box style-1">
			<h3 class="title-box">Produits par Categories</h3>
			<div class="wrap-top-banner"></div>
				...
				<div class="wrap-product-tab tab-style-1">
					...
					@foreach($categories as $key=>$category)
						<div class="tab-content-item {{$key == 0 ? 'active': ''}}" id="category_{{$category->id}}">
							<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true"  data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
								@php
									$c_products = DB::table('products')->where('category_id',$category->id)->get()->take($no_products);
								@endphp
								...
								<div class="product product-style-2 equal-elem">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">{{$c_product->regular_price}} dhs</span></div>
									</div>
								</div>
								@endforeach								
							</div>
