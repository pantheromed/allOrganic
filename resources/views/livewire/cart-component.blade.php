			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Total</span><b class="index">{{Cart::subtotal()}} dhs</b></p>
						...
						<p class="summary-info total-info "><span class="title">Total</span><b class="index">{{Cart::total()}} dhs</b></p> -->
					</div>
					<div class="checkout-info">
						<label class="checkbox-field">
							<input class="frm-input " name="have-code" id="have-code" value="" type="checkbox"><span>code promo</span>
						</label>
