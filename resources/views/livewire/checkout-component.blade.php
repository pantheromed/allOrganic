				...
				<div class="wrap-address-billing">
					...
					<form action="#" method="get" name="frm-billing">
						<p class="row-in-form">
							...
							<input id="fname" type="text" name="fname" value="" placeholder="Prenom">
						</p>
						<p class="row-in-form">
							<label for="lname">Nom<span>*</span></label>
							<input id="lname" type="text" name="lname" value="" placeholder="Nom">
						</p>
						<p class="row-in-form">
						...
						<p class="row-in-form">
							...
							<input id="phone" type="number" name="phone" value="" placeholder="06 66 66 66 66">
						</p>
						<p class="row-in-form">
						...
						<p class="row-in-form">
							...
							<input id="city" type="text" name="city" value="" placeholder="Vile">
						</p>
						<p class="row-in-form fill-wife">
							...
							<label class="checkbox-field">
								...
								<span>Livraison a autre adresse ?</span>
							</label>
						</p>
					</form>
				</div>
