					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
							...
							<div class="wrap-price">
								<span class="product-price">{{ $product->sale_price}} dhs</span>
								<del><p class="product-price">{{$product->regular_price}} dhs</p></del>
							</div>
							@else
                            <div class="wrap-price"><span class="product-price">{{ $product->regular_price}} dhs</span></div>
							@endif
                            ...
                            @foreach($related_products as $r_product)
								<div class="product product-style-2 equal-elem ">                                 
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">{{$r_product->regular_price}} dhs</span></div>
									</div>
								</div>
                            @endforeach
							</div>
