	...
	<header id="header" class="header header-style-1">
		<div class="container-fluid">
			<div class="row">
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+212) 5 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+123) 456 789</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area" style="background-color: black;color:white;" >

						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/logo.jpg') }}" alt="All Organic"></a>
						</div>
								...
								<form action="#" id="form-search-top" name="form-search-top">
									...
									<div class="wrap-list-cate">
										...
										<ul class="list-cate">
											...
											<li class="level-1">-Visage</li>
											<li class="level-2">Corps</li>
											<li class="level-2">Cheveux</li>
										</ul>
									</div>
								</form>
							</div>
